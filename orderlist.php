...
$user_id = $_SESSION['user_id']; // Replace 'user_id' with the actual key you use in your session

$stmt = $conn->prepare('SELECT u.id, o.products, o.amount_paid, o.pmode, o.date
